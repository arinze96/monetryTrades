...
<head>
    ...
    <title>Moneytarytrades | what we offer</title>
</head>
...
<body class="inner-pages ser">
    ...
    <section class="headings">
        <div class="text-heading text-center">
            <div class="container">
                <h1 style="margin-top:-10px; font-size:40px">What We Ofer</h1>
                <h2><a href="index.html">Home </a> &nbsp;>>&nbsp; what we offer</h2>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="case--study-text">
                                ...
                                <h1 style="font-style:italics; color:#0f1341">Financial Planning</h1>
								<p>
