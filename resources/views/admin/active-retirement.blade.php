                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Active Retirement Funds Deposit Request</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>This is the list of active Retirement Funds Deposit Request from customers.</p>
                                            </div>
                                            ...
                                            <div class="card card-bordered card-preview">
                                                <div class="card-inner">
                                                    <div class="table-responsive">
                                                                      ...
                                                                      <div class="dropdown">
                                                                          ...
                                                                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                                              <ul class="link-list-plain">
                                                                                  ...
                                                                                  <li><a data-action="approve" data-type="request"  class="decline_approve" href="{{ route("admin.retirement.view",["approve",$retire->id]) }}">Approve</a></li>
                                                                                  <li><a  data-action="decline" data-type="request" class="decline_approve" href="{{ route("admin.retirement.view",["decline",$retire->id]) }}">Decline</a></li>
                                                        ...
                                                        @else
                                                            <h4 class="text-center">No Active Retirement deposit requests at the moment</h4>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div><!-- .card-preview -->
