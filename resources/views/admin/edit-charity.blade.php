                     ...
                     <div class="components-preview wide-md mx-auto">
                      <div class="nk-block-head nk-block-head-lg wide-sm">
                       <div class="nk-block-head-content">
                        ...
                        <h2 class="nk-block-title fw-normal">Edit  {{ $charities->firstname }}</h2> Charity Donation Request</h2>
                       </div>
                      </div><!-- .nk-block-head -->
                       ...
                       <div class="card card-bordered card-preview">
                        <div class="card-inner">
                         <div class="preview-block">
                          ...
                          <div class="">
                           <form class="" method="POST" data-post-type="edit-plan" action="{{ route("admin.charity.view",["edit",$charities->id]) }}">
                             ...
                             <div class="col-sm-6 col-md-12 mb-2">
                              <div class="form-group">
                               <label class="form-label" for="min">Deposit Amount ({{ $charities->currency }})</label>
                               <div class="form-control-wrap">
                                <input required="" type="text" name="amount" class="form-control" id="amount" placeholder="Enter amount" value="{{ !empty(old("amount")) ? old("amount") : $charities->amount  }}">
                               </div>
                               @error('amount')
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-control-wrap">
                                <select name="status"  class="form-control">
                                  ...
                                  <option @if ((old("status") == $key) || ($charities->status == $key))
                                            selected
                                          @endif 
                            ...
                            <div class="col-sm-4 mt-3">
                             <div class="form-group">
                              <div class="form-control-wrap">
                               <button type="submit"  name="edit-plan" style="text-align:center;" class="d-block form-control btn btn-primary " >Edit Charity Donation Record</button>
                              </div>
                             </div>
                            </div>
